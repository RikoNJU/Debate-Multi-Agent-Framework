"""Alembic environment for local persistence."""
...
from debate_agent_framework.persistence.models import Base
...
if not config.get_main_option("sqlalchemy.url"):
    config.set_main_option(
        "sqlalchemy.url", DebateWebSettings.from_env().resolved_database_url()
    )
